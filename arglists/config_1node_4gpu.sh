...
export swissprot_data_root="./data/Stage2_MMD_swissprot_embedding_subset_8000.hdf5"
export pfam_data_root="./data/Stage2_MMD_pfam_embedding_subset_8000.hdf5"
