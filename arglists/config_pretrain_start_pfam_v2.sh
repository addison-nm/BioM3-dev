...
export pfam_data_root="./data/Stage2_MMD_pfam_embedding_last_ckpt_all.hdf5"
...
export resume_from_checkpoint="logs/history/Stage3_history/checkpoints/pretrain_scratch_v2_n256_d4_e100_V20260214_180702"
...
export start_pfam_trainer=True                 # CONFIDENT
