...
import biom3.Stage3.helper_funcs_aurora as help_tools
...
class MyClusterEnvironment(pl.plugins.environments.ClusterEnvironment):
    @property
...
def load_model(
    ...
    print('Length of dataloaderrrrrrrr:', len(data_module.train_dataloader()))
...
def train_model(
    ...
    # Monitor GPU usage
    gpu_logger = pl.pytorch.callbacks.DeviceStatsMonitor()
    ...
    optimizer = torch.optim.AdamW(PL_model.parameters(), lr=lr * (SIZE / gpu_devices))
