...
#=============================================================================
#
# FILE: run_grpo_smoke_5steps.sh
#
# Interactive-job equivalent of jobs/aurora/job_grpo_smoke_5steps.pbs.
# 5-step / K=4 / B=1 GRPO smoke against the matched .ckpt set:
...
#
# USAGE:
#   ./scripts/run_grpo_smoke_5steps.sh                 # logs to logs/<run_id>.o
#   ./scripts/run_grpo_smoke_5steps.sh --no-log        # stream to stdout
#
#=============================================================================
set -euo pipefail
