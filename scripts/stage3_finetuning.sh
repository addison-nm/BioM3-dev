...
#=============================================================================
#
# FILE: stage3_finetuning.sh
#
# USAGE: stage3_finetuning.sh \
#		WANDB_API_KEY config_dir config_name \
#		version_name num_nodes gpu_devices device epochs resume_from_checkpoint \
...
#	to resume training from a previous checkpoint. Also specified is the path to
#	the pretrained model, and the number of transformer blocks to finetune.
#
#=============================================================================
