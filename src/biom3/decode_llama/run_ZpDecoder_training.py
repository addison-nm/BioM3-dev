...
import biom3.decode_llama.preprocess as prep
...
def get_args(parser):
    ...
    parser.add_argument("--lm_path", type=str, default="weights/LLMs/Llama-3.2-1B",
                        help="language model identife. default is Llama-3.2-1B")
    ...
    parser.add_argument("--max_length", type=int, default=1024,
                        help="maximum number of caption tokens (length of tokenizer)")
